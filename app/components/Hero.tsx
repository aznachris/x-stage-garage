...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col items-center text-center px-4 gap-6 pt-24">
        ...
        >
          <div className="h-px w-8 bg-[#00AAFF]/40" />
          <span className="font-['JetBrains_Mono'] text-[11px] tracking-[0.4em] text-[#00AAFF]/70 uppercase">
            Service &amp; Tuning
          </span>
          <div className="h-px w-8 bg-[#00AAFF]/40" />
        </motion.div>
        ...
        >
          ...
          <a href="#booking" className="btn-neon px-8 py-4 text-sm rounded-sm">
            {t("hero.cta2")}
          </a>
        </motion.div>
        ...
        >
          {[
            ...
            { value: "15yr", labelKey: "hero.stat2" },
            { value: "100%", labelKey: "hero.stat3" },
          ].map((s) => (
            <div key={s.labelKey} className="flex flex-col items-center gap-1">
              ...
              <span className="font-['JetBrains_Mono'] text-xs tracking-widest text-[#d4d8e8]/40 uppercase">
